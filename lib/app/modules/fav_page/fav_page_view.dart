...
class FavReciepiesView extends StatelessWidget {
  const FavReciepiesView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<FavPageController>(
      init: Get.put(FavPageController()),
      builder: (logic) {
                    ...
                    body: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Expanded(
                            child: Obx(() => logic.filterRecipies.isEmpty
                                ? Center(
                                    child: Text("No Favourites Recipes available", style: GoogleFonts.poppins(fontSize: 16, color: Colors.black)),
                                  )
                                : GridView.builder(
